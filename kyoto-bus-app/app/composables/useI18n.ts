...
export type Locale = 'ja' | 'en' | 'th' | 'hi' | 'es' | 'fr' | 'zh-TW' | 'vi' | 'id' | 'ko' | 'tr' | 'it' | 'pt' | 'ar'
...
const messages: Record<Locale, Record<string, string>> = {
  ja: {
    ...
    landmarkLimit: 'ランドマークは{limit}件までです',
    geocodeNoCoords: '座標を特定できませんでした',
    kyotoPrefecture: '京都府',
    kyotoOnly: '京都府内の住所のみ登録できます',
    geocodeFail: 'ジオコーディングに失敗したにゃ:',
    addressConvertFail: '住所の変換に失敗しました',
  ...
  en: {
    ...
    landmarkLimit: 'You can register up to {limit} landmarks.',
    geocodeNoCoords: 'Could not determine the coordinates.',
    ...
    addressConvertFail: 'Failed to convert the address.',
  ...
  th: {
    ...
    landmarkLimit: 'คุณสามารถลงทะเบียนจุดสังเกตได้สูงสุด {limit} รายการ',
    geocodeNoCoords: 'ไม่สามารถระบุพิกัดได้',
    kyotoPrefecture: 'จังหวัดเกียวโต',
    kyotoOnly: 'ลงทะเบียนได้เฉพาะที่อยู่ในจังหวัดเกียวโตเท่านั้น',
    geocodeFail: 'การระบุพิกัดล้มเหลว:',
    addressConvertFail: 'แปลงที่อยู่ไม่สำเร็จ',
  ...
  hi: {
    ...
    landmarkLimit: 'आप अधिकतम {limit} लैंडमार्क पंजीकृत कर सकते हैं।',
    geocodeNoCoords: 'निर्देशांक निर्धारित नहीं किए जा सके।',
    ...
    addressConvertFail: 'पता परिवर्तित करने में विफल।',
  ...
  es: {
    ...
    landmarkLimit: 'Puedes registrar hasta {limit} puntos de referencia.',
    geocodeNoCoords: 'No se pudieron determinar las coordenadas.',
    ...
    addressConvertFail: 'No se pudo convertir la dirección.',
  ...
  fr: {
    ...
    landmarkLimit: "Vous pouvez enregistrer jusqu'à {limit} repères.",
    geocodeNoCoords: "Impossible de déterminer les coordonnées.",
    ...
    addressConvertFail: "Échec de la conversion de l'adresse.",
  ...
  'zh-TW': {
    ...
    landmarkLimit: '地標最多可登錄 {limit} 筆',
    geocodeNoCoords: '無法定位座標',
    kyotoPrefecture: '京都府',
    kyotoOnly: '僅可登錄京都府內的地址',
    geocodeFail: '地理編碼失敗：',
    addressConvertFail: '地址轉換失敗',
  ...
  vi: {
    ...
    landmarkLimit: 'Bạn chỉ có thể lưu tối đa {limit} địa điểm.',
    geocodeNoCoords: 'Không thể xác định tọa độ.',
    kyotoPrefecture: 'Tỉnh Kyoto',
    kyotoOnly: 'Chỉ có thể đăng ký địa chỉ trong tỉnh Kyoto',
    geocodeFail: 'Chuyển đổi địa chỉ thất bại:',
    addressConvertFail: 'Không thể chuyển đổi địa chỉ.',
  ...
  id: {
    ...
    stopCount: '{stops} halte ({routes} rute)',
    searchPlaceholder: 'Cari berdasarkan nama rute, operator, atau halte',
    locating: 'Mencari lokasi…',
    showMyLocation: 'Tampilkan lokasi saya',
    geoUnsupported: 'Akses lokasi tidak tersedia di browser atau koneksi ini',
    routeOperatorCount: '{operator} ({count})',
    matchedStopPrefix: '🚏 {names}',
    noMatch: 'Tidak ada rute atau halte yang cocok',
    selectedRoute: 'Dipilih: {route} ({operator})',
    clearSelection: 'Hapus',
    addLandmarkTitle: '📍 Tambah Penanda',
    addressPlaceholder: 'Masukkan alamat',
    searching: 'Mencari…',
    add: 'Tambah',
    landmarkCount: '{count} / {limit} terdaftar',
    clearBtn: 'Hapus',
    landmarkLoadFail: 'Gagal memuat penanda:',
    landmarkSaveFail: 'Gagal menyimpan penanda:',
    landmarkLimit: 'Anda dapat mendaftarkan hingga {limit} penanda.',
    geocodeNoCoords: 'Koordinat tidak dapat ditentukan.',
    kyotoPrefecture: 'Prefektur Kyoto',
    kyotoOnly: 'Hanya alamat di dalam Prefektur Kyoto yang dapat didaftarkan',
    geocodeFail: 'Geocoding gagal:',
    addressConvertFail: 'Gagal mengonversi alamat.',
    pinLimit: 'Anda dapat menyimpan hingga {limit} pin. Hapus salah satu sebelum menambahkan yang baru.',
    memoPlaceholder: 'Catatan (maks. 300 karakter)',
    saveBtn: '📌 Simpan',
    thisLocation: '📍 Lokasi Ini',
    landmarkPopupTitle: '📍 Penanda #{number}',
    pinPopupTitle: '📍 Pin #{number}',
    pinLoadFail: 'Gagal memuat pin:',
    pinSaveFail: 'Gagal menyimpan pin:',
    historyLoadFail: 'Gagal memuat riwayat:',
    historySaveFail: 'Gagal menyimpan riwayat:',
    geoNotSupported: 'Browser ini tidak mendukung akses lokasi',
    stopsNotReady: 'Data halte belum selesai dimuat',
    outsideKyoto: 'Lokasi Anda saat ini berada di luar area halte bus Kyoto, sehingga tidak dapat ditampilkan',
    myLocation: 'Lokasi Saya',
    geoPermissionDenied: 'Akses lokasi tidak diizinkan',
    geoUnavailable: 'Tidak dapat memperoleh lokasi Anda saat ini',
    geoTimeout: 'Waktu pencarian lokasi habis',
    geoFail: 'Gagal memperoleh lokasi Anda saat ini',
    geoFailLog: 'Gagal memperoleh lokasi:',
    noRouteInfo: '(tidak ada informasi rute)',
    moreCount: '+{count} lainnya',
    viewTimetable: '🕒 Lihat jadwal',
    stopPager: '{page} / {total} (operator/rute berbeda)',
    clusterLoadFail: 'Gagal memuat leaflet.markercluster. Menampilkan tanpa pengelompokan:',
    deleteThisPin: 'Hapus pin ini',
    deleteThisLandmark: 'Hapus penanda ini',
    recentlyViewed: '🕘 Halte yang baru dilihat',
    closePopup: '✕ Tutup',
    viewSolution: 'Lihat solusi',
    retryLocate: 'Coba lagi',
    settingsGuideTitle: 'Cara mengaktifkan akses lokasi',
    settingsGuideIosBrowser: '1. Buka "Pengaturan" → "Privasi & Keamanan" → "Layanan Lokasi", aktifkan jika masih nonaktif\n2. Saat halaman ini terbuka di Safari, ketuk ikon "AA" di bilah alamat → "Pengaturan Situs Web" → "Lokasi" → pilih "Izinkan"\n3. Muat ulang halaman, lalu ketuk "Coba lagi" di bawah',
    settingsGuideIosPwa: '1. Buka "Pengaturan" → "Privasi & Keamanan" → "Layanan Lokasi", aktifkan jika masih nonaktif\n2. Di Pengaturan, gulir ke bawah untuk menemukan aplikasi ini, lalu atur Lokasi ke "Saat Menggunakan Aplikasi"\n3. Kembali ke aplikasi dan ketuk "Coba lagi" di bawah',
  ...
  ko: {
    ...
    stopCount: '정류장 {stops}개 (노선 {routes}개)',
    searchPlaceholder: '노선명, 운영사, 정류장명으로 검색',
    locating: '위치 확인 중…',
    showMyLocation: '내 위치 표시',
    geoUnsupported: '이 브라우저 또는 연결 방식에서는 위치 정보를 사용할 수 없습니다',
    routeOperatorCount: '{operator} ({count}개)',
    matchedStopPrefix: '🚏 {names}',
    noMatch: '일치하는 노선이나 정류장이 없습니다',
    selectedRoute: '선택됨: {route} ({operator})',
    clearSelection: '선택 해제',
    addLandmarkTitle: '📍 랜드마크 추가',
    addressPlaceholder: '주소를 입력하세요',
    searching: '검색 중…',
    add: '추가',
    landmarkCount: '{count} / {limit}개 등록됨',
    clearBtn: '지우기',
    landmarkLoadFail: '랜드마크를 불러오지 못했습니다:',
    landmarkSaveFail: '랜드마크를 저장하지 못했습니다:',
    landmarkLimit: '랜드마크는 최대 {limit}개까지 등록할 수 있습니다.',
    geocodeNoCoords: '좌표를 확인할 수 없습니다.',
    kyotoPrefecture: '교토부',
    kyotoOnly: '교토부 내 주소만 등록할 수 있습니다',
    geocodeFail: '지오코딩에 실패했습니다:',
    addressConvertFail: '주소 변환에 실패했습니다.',
    pinLimit: '핀은 최대 {limit}개까지 저장할 수 있습니다. 새로 추가하려면 먼저 하나를 삭제해 주세요.',
    memoPlaceholder: '메모 (최대 300자)',
    saveBtn: '📌 저장',
    thisLocation: '📍 이 위치',
    landmarkPopupTitle: '📍 랜드마크 #{number}',
    pinPopupTitle: '📍 핀 #{number}',
    pinLoadFail: '핀을 불러오지 못했습니다:',
    pinSaveFail: '핀을 저장하지 못했습니다:',
    historyLoadFail: '기록을 불러오지 못했습니다:',
    historySaveFail: '기록을 저장하지 못했습니다:',
    geoNotSupported: '이 브라우저는 위치 정보 접근을 지원하지 않습니다',
    stopsNotReady: '정류장 데이터 로딩이 아직 끝나지 않았습니다',
    outsideKyoto: '현재 위치가 교토 버스 정류장 지역 밖이라 표시할 수 없습니다',
    myLocation: '내 위치',
    geoPermissionDenied: '위치 정보 접근이 허용되지 않았습니다',
    geoUnavailable: '현재 위치를 가져올 수 없습니다',
    geoTimeout: '위치 확인이 시간 초과되었습니다',
    geoFail: '현재 위치를 가져오는 데 실패했습니다',
    geoFailLog: '위치 정보를 가져오지 못했습니다:',
    noRouteInfo: '(노선 정보 없음)',
    moreCount: '외 {count}개',
    viewTimetable: '🕒 시간표 보기',
    stopPager: '{page} / {total} (운영사·노선 다름)',
    clusterLoadFail: 'leaflet.markercluster 로딩에 실패했습니다. 클러스터링 없이 표시합니다:',
    deleteThisPin: '이 핀 삭제',
    deleteThisLandmark: '이 랜드마크 삭제',
    recentlyViewed: '🕘 최근 본 정류장',
    closePopup: '✕ 닫기',
    viewSolution: '해결 방법 보기',
    retryLocate: '다시 시도',
    settingsGuideTitle: '위치 정보를 활성화하는 방법',
    settingsGuideIosBrowser: '1. "설정" 앱 → "개인정보 보호 및 보안" → "위치 서비스"가 꺼져 있다면 켜기\n2. Safari에서 이 페이지를 연 상태로 주소창의 "AA" 아이콘 탭 → "웹 사이트 설정" → "위치" → "허용" 선택\n3. 페이지를 새로고침한 뒤 아래의 "다시 시도"를 누르세요',
    settingsGuideIosPwa: '1. "설정" 앱 → "개인정보 보호 및 보안" → "위치 서비스"가 꺼져 있다면 켜기\n2. 설정 앱에서 아래로 스크롤해 이 앱을 찾아 "위치"를 "앱을 사용하는 동안"으로 설정\n3. 앱으로 돌아와 아래의 "다시 시도"를 누르세요',
  ...
  tr: {
    ...
    stopCount: '{stops} durak ({routes} hat)',
    searchPlaceholder: 'Hat adı, işletmeci veya durak adına göre ara',
    locating: 'Konum alınıyor…',
    showMyLocation: 'Konumumu göster',
    geoUnsupported: 'Bu tarayıcı veya bağlantı yönteminde konum erişimi kullanılamıyor',
    routeOperatorCount: '{operator} ({count})',
    matchedStopPrefix: '🚏 {names}',
    noMatch: 'Eşleşen hat veya durak bulunamadı',
    selectedRoute: 'Seçili: {route} ({operator})',
    clearSelection: 'Seçimi kaldır',
    addLandmarkTitle: '📍 İşaret Ekle',
    addressPlaceholder: 'Adres girin',
    searching: 'Aranıyor…',
    add: 'Ekle',
    landmarkCount: '{count} / {limit} kayıtlı',
    clearBtn: 'Temizle',
    landmarkLoadFail: 'İşaretler yüklenemedi:',
    landmarkSaveFail: 'İşaret kaydedilemedi:',
    landmarkLimit: 'En fazla {limit} işaret kaydedebilirsiniz.',
    geocodeNoCoords: 'Koordinatlar belirlenemedi.',
    kyotoPrefecture: 'Kyoto Vilayeti',
    kyotoOnly: 'Yalnızca Kyoto Vilayeti içindeki adresler kaydedilebilir',
    geocodeFail: 'Coğrafi kodlama başarısız oldu:',
    addressConvertFail: 'Adres dönüştürülemedi.',
    pinLimit: 'En fazla {limit} pin kaydedebilirsiniz. Yeni eklemeden önce birini silin.',
    memoPlaceholder: 'Not (en fazla 300 karakter)',
    saveBtn: '📌 Kaydet',
    thisLocation: '📍 Bu Konum',
    landmarkPopupTitle: '📍 İşaret #{number}',
    pinPopupTitle: '📍 Pin #{number}',
    pinLoadFail: 'Pin yüklenemedi:',
    pinSaveFail: 'Pin kaydedilemedi:',
    historyLoadFail: 'Geçmiş yüklenemedi:',
    historySaveFail: 'Geçmiş kaydedilemedi:',
    geoNotSupported: 'Bu tarayıcı konum erişimini desteklemiyor',
    stopsNotReady: 'Durak verileri henüz yüklenmedi',
    outsideKyoto: 'Mevcut konumunuz Kyoto otobüs durağı alanının dışında olduğundan gösterilemiyor',
    myLocation: 'Konumum',
    geoPermissionDenied: 'Konum erişimine izin verilmedi',
    geoUnavailable: 'Mevcut konumunuz alınamadı',
    geoTimeout: 'Konum alma işlemi zaman aşımına uğradı',
    geoFail: 'Mevcut konumunuz alınamadı',
    geoFailLog: 'Konum alınamadı:',
    noRouteInfo: '(hat bilgisi yok)',
    moreCount: '+{count} daha',
    viewTimetable: '🕒 Tarifeyi görüntüle',
    stopPager: '{page} / {total} (farklı işletmeci/hat)',
    clusterLoadFail: 'leaflet.markercluster yüklenemedi. Kümeleme olmadan gösteriliyor:',
    deleteThisPin: 'Bu pini sil',
    deleteThisLandmark: 'Bu işareti sil',
    recentlyViewed: '🕘 Son görüntülenen duraklar',
    closePopup: '✕ Kapat',
    viewSolution: 'Çözümü görüntüle',
    retryLocate: 'Tekrar dene',
    settingsGuideTitle: 'Konum erişimi nasıl etkinleştirilir',
    settingsGuideIosBrowser: '1. "Ayarlar" → "Gizlilik ve Güvenlik" → "Konum Servisleri" kapalıysa açın\n2. Bu sayfa Safari\'de açıkken adres çubuğundaki "AA" simgesine dokunun → "Web Sitesi Ayarları" → "Konum" → "İzin Ver" seçin\n3. Sayfayı yenileyip aşağıdaki "Tekrar dene"ye dokunun',
    settingsGuideIosPwa: '1. "Ayarlar" → "Gizlilik ve Güvenlik" → "Konum Servisleri" kapalıysa açın\n2. Ayarlar\'da aşağı kaydırıp bu uygulamayı bulun ve Konum\'u "Uygulamayı Kullanırken" olarak ayarlayın\n3. Uygulamaya dönüp aşağıdaki "Tekrar dene"ye dokunun',
  ...
  it: {
    ...
    stopCount: '{stops} fermate ({routes} linee)',
    searchPlaceholder: 'Cerca per nome linea, operatore o fermata',
    locating: 'Individuazione posizione…',
    showMyLocation: 'Mostra la mia posizione',
    geoUnsupported: "L'accesso alla posizione non è disponibile con questo browser o metodo di connessione",
    routeOperatorCount: '{operator} ({count})',
    matchedStopPrefix: '🚏 {names}',
    noMatch: 'Nessuna linea o fermata corrispondente',
    selectedRoute: 'Selezionata: {route} ({operator})',
    clearSelection: 'Deseleziona',
    addLandmarkTitle: '📍 Aggiungi punto di riferimento',
    addressPlaceholder: 'Inserisci indirizzo',
    searching: 'Ricerca in corso…',
    add: 'Aggiungi',
    landmarkCount: '{count} / {limit} registrati',
    clearBtn: 'Cancella',
    landmarkLoadFail: 'Impossibile caricare i punti di riferimento:',
    landmarkSaveFail: 'Impossibile salvare il punto di riferimento:',
    landmarkLimit: 'Puoi registrare fino a {limit} punti di riferimento.',
    geocodeNoCoords: 'Impossibile determinare le coordinate.',
    kyotoPrefecture: 'Prefettura di Kyoto',
    kyotoOnly: 'Puoi registrare solo indirizzi all\'interno della Prefettura di Kyoto',
    geocodeFail: 'Geocodifica non riuscita:',
    addressConvertFail: "Impossibile convertire l'indirizzo.",
    pinLimit: 'Puoi salvare fino a {limit} pin. Eliminane uno prima di aggiungerne uno nuovo.',
    memoPlaceholder: 'Nota (massimo 300 caratteri)',
    saveBtn: '📌 Salva',
    thisLocation: '📍 Questa posizione',
    landmarkPopupTitle: '📍 Punto di riferimento #{number}',
    pinPopupTitle: '📍 Pin #{number}',
    pinLoadFail: 'Impossibile caricare il pin:',
    pinSaveFail: 'Impossibile salvare il pin:',
    historyLoadFail: 'Impossibile caricare la cronologia:',
    historySaveFail: 'Impossibile salvare la cronologia:',
    geoNotSupported: 'Questo browser non supporta l\'accesso alla posizione',
    stopsNotReady: 'Il caricamento dei dati delle fermate non è ancora completo',
    outsideKyoto: 'La tua posizione attuale è al di fuori dell\'area delle fermate degli autobus di Kyoto, quindi non può essere mostrata',
    myLocation: 'La mia posizione',
    geoPermissionDenied: "L'accesso alla posizione non è stato consentito",
    geoUnavailable: 'Impossibile ottenere la tua posizione attuale',
    geoTimeout: 'Timeout durante la ricerca della posizione',
    geoFail: 'Impossibile ottenere la tua posizione attuale',
    geoFailLog: 'Impossibile ottenere la posizione:',
    noRouteInfo: '(nessuna informazione sulla linea)',
    moreCount: '+altre {count}',
    viewTimetable: '🕒 Visualizza orario',
    stopPager: '{page} / {total} (operatore/linea diversi)',
    clusterLoadFail: 'Impossibile caricare leaflet.markercluster. Visualizzazione senza raggruppamento:',
    deleteThisPin: 'Elimina questo pin',
    deleteThisLandmark: 'Elimina questo punto di riferimento',
    recentlyViewed: '🕘 Fermate visualizzate di recente',
    closePopup: '✕ Chiudi',
    viewSolution: 'Visualizza soluzione',
    retryLocate: 'Riprova',
    settingsGuideTitle: 'Come attivare l\'accesso alla posizione',
    settingsGuideIosBrowser: '1. Apri "Impostazioni" → "Privacy e sicurezza" → "Posizione", attivala se disattivata\n2. Con questa pagina aperta in Safari, tocca l\'icona "AA" nella barra degli indirizzi → "Impostazioni sito web" → "Posizione" → seleziona "Consenti"\n3. Ricarica la pagina, quindi tocca "Riprova" qui sotto',
    settingsGuideIosPwa: '1. Apri "Impostazioni" → "Privacy e sicurezza" → "Posizione", attivala se disattivata\n2. In Impostazioni, scorri verso il basso per trovare questa app e imposta Posizione su "Durante l\'uso dell\'app"\n3. Torna all\'app e tocca "Riprova" qui sotto',
  ...
  pt: {
    ...
    stopCount: '{stops} paradas ({routes} linhas)',
    searchPlaceholder: 'Pesquisar por nome da linha, operadora ou parada',
    locating: 'Localizando…',
    showMyLocation: 'Mostrar minha localização',
    geoUnsupported: 'O acesso à localização não está disponível neste navegador ou método de conexão',
    routeOperatorCount: '{operator} ({count})',
    matchedStopPrefix: '🚏 {names}',
    noMatch: 'Nenhuma linha ou parada correspondente encontrada',
    selectedRoute: 'Selecionado: {route} ({operator})',
    clearSelection: 'Limpar seleção',
    addLandmarkTitle: '📍 Adicionar marco',
    addressPlaceholder: 'Digite o endereço',
    searching: 'Pesquisando…',
    add: 'Adicionar',
    landmarkCount: '{count} / {limit} registrados',
    clearBtn: 'Limpar',
    landmarkLoadFail: 'Falha ao carregar marcos:',
    landmarkSaveFail: 'Falha ao salvar marco:',
    landmarkLimit: 'Você pode registrar até {limit} marcos.',
    geocodeNoCoords: 'Não foi possível determinar as coordenadas.',
    kyotoPrefecture: 'Prefeitura de Kyoto',
    kyotoOnly: 'Somente endereços dentro da Prefeitura de Kyoto podem ser registrados',
    geocodeFail: 'Falha na geocodificação:',
    addressConvertFail: 'Falha ao converter o endereço.',
    pinLimit: 'Você pode salvar até {limit} pins. Exclua um antes de adicionar um novo.',
    memoPlaceholder: 'Nota (máx. 300 caracteres)',
    saveBtn: '📌 Salvar',
    thisLocation: '📍 Este local',
    landmarkPopupTitle: '📍 Marco #{number}',
    pinPopupTitle: '📍 Pin #{number}',
    pinLoadFail: 'Falha ao carregar o pin:',
    pinSaveFail: 'Falha ao salvar o pin:',
    historyLoadFail: 'Falha ao carregar o histórico:',
    historySaveFail: 'Falha ao salvar o histórico:',
    geoNotSupported: 'Este navegador não suporta acesso à localização',
    stopsNotReady: 'O carregamento dos dados das paradas ainda não foi concluído',
    outsideKyoto: 'Sua localização atual está fora da área de paradas de ônibus de Kyoto, portanto não pode ser exibida',
    myLocation: 'Minha localização',
    geoPermissionDenied: 'O acesso à localização não foi permitido',
    geoUnavailable: 'Não foi possível obter sua localização atual',
    geoTimeout: 'A busca pela localização expirou',
    geoFail: 'Falha ao obter sua localização atual',
    geoFailLog: 'Falha ao obter a localização:',
    noRouteInfo: '(sem informações da linha)',
    moreCount: '+{count} mais',
    viewTimetable: '🕒 Ver horário',
    stopPager: '{page} / {total} (operadora/linha diferentes)',
    clusterLoadFail: 'Falha ao carregar leaflet.markercluster. Exibindo sem agrupamento:',
    deleteThisPin: 'Excluir este pin',
    deleteThisLandmark: 'Excluir este marco',
    recentlyViewed: '🕘 Paradas vistas recentemente',
    closePopup: '✕ Fechar',
    viewSolution: 'Ver solução',
    retryLocate: 'Tentar novamente',
    settingsGuideTitle: 'Como ativar o acesso à localização',
    settingsGuideIosBrowser: '1. Abra "Ajustes" → "Privacidade e Segurança" → "Serviços de Localização", ative se estiver desativado\n2. Com esta página aberta no Safari, toque no ícone "AA" na barra de endereço → "Ajustes do Site" → "Localização" → selecione "Permitir"\n3. Recarregue a página e toque em "Tentar novamente" abaixo',
    settingsGuideIosPwa: '1. Abra "Ajustes" → "Privacidade e Segurança" → "Serviços de Localização", ative se estiver desativado\n2. Em Ajustes, role para baixo para encontrar este aplicativo e defina Localização como "Ao Usar o App"\n3. Volte ao aplicativo e toque em "Tentar novamente" abaixo',
  ...
  ar: {
    ...
    landmarkLimit: 'يمكنك تسجيل ما يصل إلى {limit} علامة.',
    geocodeNoCoords: 'تعذّر تحديد الإحداثيات.',
    kyotoPrefecture: 'محافظة كيوتو',
    kyotoOnly: 'يمكن تسجيل العناوين الواقعة داخل محافظة كيوتو فقط',
    geocodeFail: 'فشل الترميز الجغرافي:',
    addressConvertFail: 'فشل تحويل العنوان.',
