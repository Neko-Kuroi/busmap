...
const messages: Record<Locale, Record<string, string>> = {
  ...
  id: {
    ...
    landmarkLimit: 'Anda dapat mendaftarkan hingga {limit} penanda. Hapus salah satu sebelum menambahkan yang baru.',
    geocodeNoCoords: 'Koordinat tidak dapat ditentukan. Silakan periksa alamatnya.',
    ...
    addressConvertFail: 'Gagal mengonversi alamat. Silakan coba lagi nanti.',
  ...
  ko: {
    ...
    landmarkLimit: '랜드마크는 최대 {limit}개까지 등록할 수 있습니다. 새로 추가하려면 먼저 하나를 삭제해 주세요.',
    geocodeNoCoords: '좌표를 확인할 수 없습니다. 주소를 다시 확인해 주세요.',
    kyotoPrefecture: '교토부',
    kyotoOnly: '교토부 내 주소만 등록할 수 있습니다',
    geocodeFail: '지오코딩에 실패했습니다:',
    addressConvertFail: '주소 변환에 실패했습니다. 잠시 후 다시 시도해 주세요.',
  ...
  tr: {
    ...
    landmarkLimit: 'En fazla {limit} işaret kaydedebilirsiniz. Yeni eklemeden önce birini silin.',
    geocodeNoCoords: 'Koordinatlar belirlenemedi. Lütfen adresi kontrol edin.',
    ...
    addressConvertFail: 'Adres dönüştürülemedi. Lütfen daha sonra tekrar deneyin.',
  ...
  it: {
    ...
    landmarkLimit: 'Puoi registrare fino a {limit} punti di riferimento. Eliminane uno prima di aggiungerne uno nuovo.',
    geocodeNoCoords: 'Impossibile determinare le coordinate. Controlla l\'indirizzo.',
    ...
    addressConvertFail: "Impossibile convertire l'indirizzo. Riprova più tardi.",
  ...
  pt: {
    ...
    landmarkLimit: 'Você pode registrar até {limit} marcos. Exclua um antes de adicionar um novo.',
    geocodeNoCoords: 'Não foi possível determinar as coordenadas. Verifique o endereço.',
    ...
    addressConvertFail: 'Falha ao converter o endereço. Tente novamente mais tarde.',
