...
L.geoJson(features, {
  onEachFeature: function (features, layer) {
    if (
      ...
      features.properties.name2
    ) {
      temp = "\<p\>" + features.properties.name + "\<\/p\>" + "\<p\>" + features.properties.name2 + "\<\/p\>";
      ...
      layer.on("click", function (e) {
        //alert(features.properties.name);
        window.open(features.properties.URL);
      });
    }
  }
}).addTo(map);
